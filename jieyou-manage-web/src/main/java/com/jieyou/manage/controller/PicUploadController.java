...
import com.jieyou.common.PicUploadResult;
...
public class PicUploadController {
	...
	public String upload(@RequestParam("uploadFile") MultipartFile uploadFile , HttpServletResponse response) throws Exception {
		...
		// 生成图片的绝对引用地址
		String picUrl = StringUtils.replace(StringUtils.substringAfter(filePath, "D:\\jieyou\\jieuyou-upload"), "\\", "/");
		fileUploadResult.setUrl("http://image.jieyou.com" + picUrl);
	...
	private String getFilePath(String sourceFileName) {
		String baseFolder = "D:\\jieyou\\jieuyou-upload" + File.separator + "images";
